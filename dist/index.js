  ...
  return _createClass(ConsoleLogger, [{
    ...
    value: function warn(title) {
      ...
      if (ConsoleLogger.noColor) {
        ...
        var _console0;
        (_console0 = console).warn.apply(_console0, ["%c[".concat(this.prefix, "] ").concat(title), this.warnColor].concat(args));
      }
    }
    /**
     * error
    ...
    value: function error(title) {
      ...
      if (ConsoleLogger.noColor) {
        var _console1;
        (_console1 = console).error.apply(_console1, ["[".concat(this.prefix, "] ").concat(title)].concat(args));
      } else {
        var _console10;
        (_console10 = console).error.apply(_console10, ["%c[".concat(this.prefix, "] ").concat(title), this.errorColor].concat(args));
      }
    }
    /**
     * fatal error
    ...
    value: function fatal(title) {
      ...
      if (ConsoleLogger.noColor) {
        ...
        var _console12;
        (_console12 = console).error.apply(_console12, ["%c[".concat(this.prefix, "] ").concat(title), this.fatalColor].concat(args));
      }
    }
    /**
    ...
    value: function group() {
      if (console.group) {
        var _console13;
        (_console13 = console).group.apply(_console13, arguments);
      }
    }
    /**
     * end a group
    ...
    value: function groupCollapsed() {
      if (console.groupCollapsed) {
        var _console14;
        (_console14 = console).groupCollapsed.apply(_console14, arguments);
      }
    }
  }], [{
    key: "setLevel",
